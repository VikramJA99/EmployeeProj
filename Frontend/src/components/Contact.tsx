...
function ContactUs() {
  ...
  const handleSubmit = async (e: { preventDefault: () => void }) => {
    ...
    axios
      .get("https://thay-db.vercel.app/email/", { params: formData })
    ...
    <div className="container mt-5">
      <div className="row mb-3 mt-0">
        ...
        <div className="col-12 col-md-4 d-flex flex-column align-items-center mb-4 mb-md-0">
          ...
          <a
            href="https://maps.app.goo.gl/DJWUKgH1ao7WAwtu6"
            target="_blank"
      ...
      <div className="row">
        <div className="col-md-12 d-flex justify-content-center">
          ...
          >
            <h3 className="mb-4" style={{ fontFamily: "Garamond, serif" }}>
              Contact Us:
              <hr />
            </h3>
            <form onSubmit={handleSubmit}>
              ...
              <div className="row mb-2">
                <div
                  className="col-md-12 d-flex gap-2 justify-content-center align-items-center"
