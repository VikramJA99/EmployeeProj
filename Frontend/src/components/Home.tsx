  ...
  return (
    <div style={containerStyle}>
      <div style={imageContainerStyle}>
        <img src="/web-des.svg" alt="Description" style={imageStyle} />
      </div>
      <div style={textContainerStyle}>
        <h2 style={headerStyle}>
          <b />
          THAY TECH WELCOMES YOU
          <br />
        ...
        <p style={{ fontFamily: 'Times New Roman", Times, serif' }}>
          ...
          <br />. With its state-of-the-art infrastructure and amicable location
          in the heart of the city, Thay Technologies intends to add value to IT
          companies.
        </p>
      </div>
    </div>
