                ...
                <div className="col-md-7">
                  <div className="card-body p-0">
                    ...
                    <p className="card-text lead">
                      ...
                      services. With a fresh and forward-thinking approach, Thay
                      Technology serves as a strategic liaison, fostering
              ...
              <div className="row gy-3 gy-md-0 align-items-md-center">
                ...
                <div className="col-md-7">
                  <div className="card-body p-0">
                    ...
                    <p className="card-text lead">
                      Our Employees are highly qualified professionals in their
                      respective areas. Their technical expertise and
                      hands-on-experience make our firm stand out of the crowd.
                      Not only do our employees enjoy the freedom and comforts
                      of the best-in-class work environment, but also are
